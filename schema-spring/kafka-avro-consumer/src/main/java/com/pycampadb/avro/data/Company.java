...
public class Company extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Company(java.util.List<Branch> branches, String code, Long companyId, String name) {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: branches = (java.util.List<Branch>)value$; break;
   ...
   */
  public void setBranches(java.util.List<Branch> value) {
    this.branches = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Company>
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setBranches(java.util.List<Branch> value) {
    ...
    public Company build() {
      try {
        ...
        record.branches = fieldSetFlags()[0] ? this.branches : (java.util.List<Branch>) defaultValue(fields()[0]);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      java.util.List<Branch> a0 = this.branches;
      if (a0 == null) {
        a0 = new SpecificData.Array<Branch>((int)size0, SCHEMA$.getField("branches").schema());
        this.branches = a0;
      } else a0.clear();
      SpecificData.Array<Branch> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<Branch>)a0 : null);
      for ( ; 0 < size0; size0 = in.arrayNext()) {
        for ( ; size0 != 0; size0--) {
          Branch e0 = (ga0 != null ? ga0.peek() : null);
          if (e0 == null) {
            e0 = new Branch();
          }
          e0.customDecode(in);
