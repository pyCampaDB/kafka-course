...
public class Avro04 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private Avro04Enum allowedColor;
   ...
   */
  public Avro04(Avro04Enum allowedColor) {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: allowedColor = (Avro04Enum)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public Avro04Enum getAllowedColor() {
    return allowedColor;
  }
   ...
   */
  public void setAllowedColor(Avro04Enum value) {
   ...
   * @return A new Avro04 RecordBuilder
   */
  public static Builder newBuilder(Avro04 other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Avro04>
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setAllowedColor(Avro04Enum value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder clearAllowedColor() {
      allowedColor = null;
    ...
    public Avro04 build() {
      try {
        ...
        record.allowedColor = fieldSetFlags()[0] ? this.allowedColor : (Avro04Enum) defaultValue(fields()[0]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      this.allowedColor = Avro04Enum.values()[in.readEnum()];
