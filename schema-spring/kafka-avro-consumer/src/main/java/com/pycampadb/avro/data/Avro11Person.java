...
public class Avro11Person extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private Avro11Address address;
  private java.util.List<Avro11BankAccount> bankAccounts;
   ...
   */
  public Avro11Person(String firstName, String lastName, java.time.LocalDate birthDate, Avro11Address address, java.util.List<Avro11BankAccount> bankAccounts) {
  ...
  public void put(int field$, Object value$) {
    ...
    case 3: address = (Avro11Address)value$; break;
    case 4: bankAccounts = (java.util.List<Avro11BankAccount>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public Avro11Address getAddress() {
    return address;
  }
   ...
   * @param value the value to set.
   */
  public void setAddress(Avro11Address value) {
    this.address = value;
  }
   ...
   */
  public java.util.List<Avro11BankAccount> getBankAccounts() {
    return bankAccounts;
  }
   ...
   * @param value the value to set.
   */
  public void setBankAccounts(java.util.List<Avro11BankAccount> value) {
   ...
   * @return A new Avro11Person RecordBuilder
   */
  public static Builder newBuilder(Avro11Person other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Avro11Person>
    ...
    private java.time.LocalDate birthDate;
    private Avro11Address address;
    private Avro11Address.Builder addressBuilder;
    private java.util.List<Avro11BankAccount> bankAccounts;
    ...
    private Builder(Builder other) {
      ...
      if (other.hasAddressBuilder()) {
        this.addressBuilder = Avro11Address.newBuilder(other.getAddressBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Avro11Person other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.firstName)) {
        this.firstName = data().deepCopy(fields()[0].schema(), other.firstName);
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setBirthDate(java.time.LocalDate value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setAddress(Avro11Address value) {
     ...
     * @return This builder.
     */
    public Avro11Address.Builder getAddressBuilder() {
      if (addressBuilder == null) {
        if (hasAddress()) {
          setAddressBuilder(Avro11Address.newBuilder(address));
        } else {
          setAddressBuilder(Avro11Address.newBuilder());
        }
      }
    ...
    public Builder setAddressBuilder(Avro11Address.Builder value) {
      clearAddress();
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setBankAccounts(java.util.List<Avro11BankAccount> value) {
    ...
    public Avro11Person build() {
      try {
        ...
        if (addressBuilder != null) {
          ...
          record.address = fieldSetFlags()[3] ? this.address : (Avro11Address) defaultValue(fields()[3]);
        }
        record.bankAccounts = fieldSetFlags()[4] ? this.bankAccounts : (java.util.List<Avro11BankAccount>) defaultValue(fields()[4]);
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
      } catch (Exception e) {
