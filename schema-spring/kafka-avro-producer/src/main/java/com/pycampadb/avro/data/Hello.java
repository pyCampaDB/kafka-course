...
public class Hello extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6136247753895199880L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Hello\",\"namespace\":\"com.pycampadb.avro.data\",\"doc\":\"Hello world avro\",\"fields\":[{\"name\":\"myStringField\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"Just a string\"},{\"name\":\"myIntField\",\"type\":\"int\",\"doc\":\"Just an int\"}]}");
   ...
   */
  public Hello(String myStringField, Integer myIntField) {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: myStringField = value$ != null ? value$.toString() : null; break;
    case 1: myIntField = (Integer)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public static com.pycampadb.avro.data.Hello.Builder newBuilder() {
    return new com.pycampadb.avro.data.Hello.Builder();
  }
   ...
   * @return A new Hello RecordBuilder
   */
  public static com.pycampadb.avro.data.Hello.Builder newBuilder(com.pycampadb.avro.data.Hello.Builder other) {
    if (other == null) {
      return new com.pycampadb.avro.data.Hello.Builder();
    } else {
      return new com.pycampadb.avro.data.Hello.Builder(other);
    }
  }
   ...
   * @return A new Hello RecordBuilder
   */
  public static com.pycampadb.avro.data.Hello.Builder newBuilder(com.pycampadb.avro.data.Hello other) {
    if (other == null) {
      return new com.pycampadb.avro.data.Hello.Builder();
    } else {
      return new com.pycampadb.avro.data.Hello.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Hello>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pycampadb.avro.data.Hello.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pycampadb.avro.data.Hello other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.myStringField)) {
        this.myStringField = data().deepCopy(fields()[0].schema(), other.myStringField);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Hello.Builder setMyStringField(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Hello.Builder clearMyStringField() {
      myStringField = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Hello.Builder setMyIntField(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Hello.Builder clearMyIntField() {
    ...
    public Hello build() {
      try {
        ...
        record.myStringField = fieldSetFlags()[0] ? this.myStringField : (String) defaultValue(fields()[0]);
        record.myIntField = fieldSetFlags()[1] ? this.myIntField : (Integer) defaultValue(fields()[1]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      this.myStringField = in.readString();
