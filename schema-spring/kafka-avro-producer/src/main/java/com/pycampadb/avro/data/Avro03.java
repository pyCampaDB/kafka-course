...
public class Avro03 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1340066137817718324L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Avro03\",\"namespace\":\"com.pycampadb.avro.data\",\"doc\":\"Sample optional using union\",\"fields\":[{\"name\":\"myMandatoryValue\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"myOptionalValue\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"myOptionalValueWithDefault\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\"},\"null\"],\"default\":\"The default value\"},{\"name\":\"myWeirdButPossibleValue\",\"type\":[\"int\",\"boolean\"]}]}");
  ...
  private String myOptionalValue;
  private String myOptionalValueWithDefault;
  private Object myWeirdButPossibleValue;
   ...
   */
  public Avro03(String myMandatoryValue, String myOptionalValue, String myOptionalValueWithDefault, Object myWeirdButPossibleValue) {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: myMandatoryValue = value$ != null ? value$.toString() : null; break;
    case 1: myOptionalValue = value$ != null ? value$.toString() : null; break;
    case 2: myOptionalValueWithDefault = value$ != null ? value$.toString() : null; break;
   ...
   */
  public String getMyMandatoryValue() {
   ...
   */
  public void setMyMandatoryValue(String value) {
   ...
   */
  public String getMyOptionalValue() {
   ...
   * @param value the value to set.
   */
  public void setMyOptionalValue(String value) {
   ...
   */
  public String getMyOptionalValueWithDefault() {
   ...
   * @param value the value to set.
   */
  public void setMyOptionalValueWithDefault(String value) {
   ...
   */
  public Object getMyWeirdButPossibleValue() {
   ...
   * @param value the value to set.
   */
  public void setMyWeirdButPossibleValue(Object value) {
   ...
   */
  public static com.pycampadb.avro.data.Avro03.Builder newBuilder() {
    return new com.pycampadb.avro.data.Avro03.Builder();
  }
   ...
   * @return A new Avro03 RecordBuilder
   */
  public static com.pycampadb.avro.data.Avro03.Builder newBuilder(com.pycampadb.avro.data.Avro03.Builder other) {
    if (other == null) {
      return new com.pycampadb.avro.data.Avro03.Builder();
    } else {
      return new com.pycampadb.avro.data.Avro03.Builder(other);
    }
  }
   ...
   * @return A new Avro03 RecordBuilder
   */
  public static com.pycampadb.avro.data.Avro03.Builder newBuilder(com.pycampadb.avro.data.Avro03 other) {
    if (other == null) {
      return new com.pycampadb.avro.data.Avro03.Builder();
    } else {
      return new com.pycampadb.avro.data.Avro03.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Avro03>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pycampadb.avro.data.Avro03.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pycampadb.avro.data.Avro03 other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.myMandatoryValue)) {
        this.myMandatoryValue = data().deepCopy(fields()[0].schema(), other.myMandatoryValue);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro03.Builder setMyMandatoryValue(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro03.Builder clearMyMandatoryValue() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro03.Builder setMyOptionalValue(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro03.Builder clearMyOptionalValue() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro03.Builder setMyOptionalValueWithDefault(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro03.Builder clearMyOptionalValueWithDefault() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro03.Builder setMyWeirdButPossibleValue(Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro03.Builder clearMyWeirdButPossibleValue() {
    ...
    public Avro03 build() {
      try {
        ...
        record.myMandatoryValue = fieldSetFlags()[0] ? this.myMandatoryValue : (String) defaultValue(fields()[0]);
        record.myOptionalValue = fieldSetFlags()[1] ? this.myOptionalValue : (String) defaultValue(fields()[1]);
        record.myOptionalValueWithDefault = fieldSetFlags()[2] ? this.myOptionalValueWithDefault : (String) defaultValue(fields()[2]);
