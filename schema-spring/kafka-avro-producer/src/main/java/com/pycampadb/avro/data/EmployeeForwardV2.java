...
public class EmployeeForwardV2 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.pycampadb.avro.data.EmployeeForwardV2.Builder newBuilder() {
    return new com.pycampadb.avro.data.EmployeeForwardV2.Builder();
  }
   ...
   * @return A new EmployeeForwardV2 RecordBuilder
   */
  public static com.pycampadb.avro.data.EmployeeForwardV2.Builder newBuilder(com.pycampadb.avro.data.EmployeeForwardV2.Builder other) {
    if (other == null) {
      return new com.pycampadb.avro.data.EmployeeForwardV2.Builder();
    } else {
      return new com.pycampadb.avro.data.EmployeeForwardV2.Builder(other);
    }
  }
   ...
   * @return A new EmployeeForwardV2 RecordBuilder
   */
  public static com.pycampadb.avro.data.EmployeeForwardV2.Builder newBuilder(com.pycampadb.avro.data.EmployeeForwardV2 other) {
    if (other == null) {
      return new com.pycampadb.avro.data.EmployeeForwardV2.Builder();
    } else {
      return new com.pycampadb.avro.data.EmployeeForwardV2.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EmployeeForwardV2>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pycampadb.avro.data.EmployeeForwardV2.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pycampadb.avro.data.EmployeeForwardV2 other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.firstName)) {
        this.firstName = data().deepCopy(fields()[0].schema(), other.firstName);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.EmployeeForwardV2.Builder setFirstName(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.EmployeeForwardV2.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.EmployeeForwardV2.Builder setLastName(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.EmployeeForwardV2.Builder clearLastName() {
      lastName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.EmployeeForwardV2.Builder setEmail(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.EmployeeForwardV2.Builder clearEmail() {
      email = null;
