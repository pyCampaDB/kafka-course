...
public class Avro11Country extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.pycampadb.avro.data.Avro11Country.Builder newBuilder() {
    return new com.pycampadb.avro.data.Avro11Country.Builder();
  }
   ...
   * @return A new Avro11Country RecordBuilder
   */
  public static com.pycampadb.avro.data.Avro11Country.Builder newBuilder(com.pycampadb.avro.data.Avro11Country.Builder other) {
    if (other == null) {
      return new com.pycampadb.avro.data.Avro11Country.Builder();
    } else {
      return new com.pycampadb.avro.data.Avro11Country.Builder(other);
    }
  }
   ...
   * @return A new Avro11Country RecordBuilder
   */
  public static com.pycampadb.avro.data.Avro11Country.Builder newBuilder(com.pycampadb.avro.data.Avro11Country other) {
    if (other == null) {
      return new com.pycampadb.avro.data.Avro11Country.Builder();
    } else {
      return new com.pycampadb.avro.data.Avro11Country.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Avro11Country>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pycampadb.avro.data.Avro11Country.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pycampadb.avro.data.Avro11Country other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.code)) {
        this.code = data().deepCopy(fields()[0].schema(), other.code);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro11Country.Builder setCode(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro11Country.Builder clearCode() {
      code = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro11Country.Builder setName(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro11Country.Builder clearName() {
      name = null;
