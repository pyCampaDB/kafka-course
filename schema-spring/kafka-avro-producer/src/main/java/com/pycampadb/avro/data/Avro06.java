...
public class Avro06 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8495627038568430979L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Avro06\",\"namespace\":\"com.pycampadb.avro.data\",\"doc\":\"Sample array\",\"fields\":[{\"name\":\"emails\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},\"doc\":\"mandatory array\"},{\"name\":\"numbers\",\"type\":{\"type\":\"array\",\"items\":\"int\"},\"doc\":\"mandatory array, with default\",\"default\":[4,98]},{\"name\":\"quotes\",\"type\":[\"null\",{\"type\":\"array\",\"items\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}],\"doc\":\"optional array\",\"default\":null}]}");
   ...
   */
  public Avro06(java.util.List<String> emails, java.util.List<Integer> numbers, java.util.List<String> quotes) {
    this.emails = emails;
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: emails = (java.util.List<String>)value$; break;
    case 1: numbers = (java.util.List<Integer>)value$; break;
    case 2: quotes = (java.util.List<String>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public void setEmails(java.util.List<String> value) {
    this.emails = value;
  }
   ...
   * @param value the value to set.
   */
  public void setNumbers(java.util.List<Integer> value) {
    this.numbers = value;
  }
   ...
   * @param value the value to set.
   */
  public void setQuotes(java.util.List<String> value) {
    this.quotes = value;
  }
   ...
   */
  public static com.pycampadb.avro.data.Avro06.Builder newBuilder() {
    return new com.pycampadb.avro.data.Avro06.Builder();
  }
   ...
   * @return A new Avro06 RecordBuilder
   */
  public static com.pycampadb.avro.data.Avro06.Builder newBuilder(com.pycampadb.avro.data.Avro06.Builder other) {
    if (other == null) {
      return new com.pycampadb.avro.data.Avro06.Builder();
    } else {
      return new com.pycampadb.avro.data.Avro06.Builder(other);
    }
  }
   ...
   * @return A new Avro06 RecordBuilder
   */
  public static com.pycampadb.avro.data.Avro06.Builder newBuilder(com.pycampadb.avro.data.Avro06 other) {
    if (other == null) {
      return new com.pycampadb.avro.data.Avro06.Builder();
    } else {
      return new com.pycampadb.avro.data.Avro06.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Avro06>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pycampadb.avro.data.Avro06.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pycampadb.avro.data.Avro06 other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.emails)) {
        this.emails = data().deepCopy(fields()[0].schema(), other.emails);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro06.Builder setEmails(java.util.List<String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro06.Builder clearEmails() {
      emails = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro06.Builder setNumbers(java.util.List<Integer> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro06.Builder clearNumbers() {
      numbers = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro06.Builder setQuotes(java.util.List<String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro06.Builder clearQuotes() {
      quotes = null;
    ...
    public Avro06 build() {
      try {
        ...
        record.emails = fieldSetFlags()[0] ? this.emails : (java.util.List<String>) defaultValue(fields()[0]);
        record.numbers = fieldSetFlags()[1] ? this.numbers : (java.util.List<Integer>) defaultValue(fields()[1]);
        record.quotes = fieldSetFlags()[2] ? this.quotes : (java.util.List<String>) defaultValue(fields()[2]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      java.util.List<String> a0 = this.emails;
      if (a0 == null) {
        a0 = new SpecificData.Array<String>((int)size0, SCHEMA$.getField("emails").schema());
        this.emails = a0;
      } else a0.clear();
      ...
      java.util.List<Integer> a1 = this.numbers;
      if (a1 == null) {
        a1 = new SpecificData.Array<Integer>((int)size1, SCHEMA$.getField("numbers").schema());
        this.numbers = a1;
      } else a1.clear();
      ...
      if (in.readIndex() != 1) {
        ...
        java.util.List<String> a2 = this.quotes;
        if (a2 == null) {
          a2 = new SpecificData.Array<String>((int)size2, SCHEMA$.getField("quotes").schema().getTypes().get(1));
          this.quotes = a2;
        } else a2.clear();
        SpecificData.Array<String> ga2 = (a2 instanceof SpecificData.Array ? (SpecificData.Array<String>)a2 : null);
        for ( ; 0 < size2; size2 = in.arrayNext()) {
          for ( ; size2 != 0; size2--) {
            String e2 = (ga2 != null ? ga2.peek() : null);
            e2 = in.readString();
            a2.add(e2);
          }
        }
