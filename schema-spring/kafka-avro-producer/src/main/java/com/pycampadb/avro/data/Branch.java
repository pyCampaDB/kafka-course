...
public class Branch extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1924423750460336007L;
   ...
   */
  public Branch(String address, Long branchId, String city, String country) {
  ...
  public void put(int field$, Object value$) {
    ...
    case 1: branchId = (Long)value$; break;
   ...
   */
  public static com.pycampadb.avro.data.Branch.Builder newBuilder() {
    return new com.pycampadb.avro.data.Branch.Builder();
  }
   ...
   * @return A new Branch RecordBuilder
   */
  public static com.pycampadb.avro.data.Branch.Builder newBuilder(com.pycampadb.avro.data.Branch.Builder other) {
    if (other == null) {
      return new com.pycampadb.avro.data.Branch.Builder();
    } else {
      return new com.pycampadb.avro.data.Branch.Builder(other);
    }
  }
   ...
   * @return A new Branch RecordBuilder
   */
  public static com.pycampadb.avro.data.Branch.Builder newBuilder(com.pycampadb.avro.data.Branch other) {
    if (other == null) {
      return new com.pycampadb.avro.data.Branch.Builder();
    } else {
      return new com.pycampadb.avro.data.Branch.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Branch>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pycampadb.avro.data.Branch.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pycampadb.avro.data.Branch other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.address)) {
        this.address = data().deepCopy(fields()[0].schema(), other.address);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Branch.Builder setAddress(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Branch.Builder clearAddress() {
      address = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Branch.Builder setBranchId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Branch.Builder clearBranchId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Branch.Builder setCity(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Branch.Builder clearCity() {
      city = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Branch.Builder setCountry(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Branch.Builder clearCountry() {
      country = null;
    ...
    public Branch build() {
      try {
        ...
        record.branchId = fieldSetFlags()[1] ? this.branchId : (Long) defaultValue(fields()[1]);
        record.city = fieldSetFlags()[2] ? this.city : (String) defaultValue(fields()[2]);
        record.country = fieldSetFlags()[3] ? this.country : (String) defaultValue(fields()[3]);
        return record;
