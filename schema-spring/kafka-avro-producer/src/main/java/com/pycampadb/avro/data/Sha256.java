...
public class Sha256 extends org.apache.avro.specific.SpecificFixed {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"fixed\",\"name\":\"Sha256\",\"namespace\":\"com.pycampadb.avro.data\",\"size\":32}");
