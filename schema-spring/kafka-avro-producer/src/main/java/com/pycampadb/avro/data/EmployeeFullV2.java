...
public class EmployeeFullV2 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.pycampadb.avro.data.EmployeeFullV2.Builder newBuilder() {
    return new com.pycampadb.avro.data.EmployeeFullV2.Builder();
  }
   ...
   * @return A new EmployeeFullV2 RecordBuilder
   */
  public static com.pycampadb.avro.data.EmployeeFullV2.Builder newBuilder(com.pycampadb.avro.data.EmployeeFullV2.Builder other) {
    if (other == null) {
      return new com.pycampadb.avro.data.EmployeeFullV2.Builder();
    } else {
      return new com.pycampadb.avro.data.EmployeeFullV2.Builder(other);
    }
  }
   ...
   * @return A new EmployeeFullV2 RecordBuilder
   */
  public static com.pycampadb.avro.data.EmployeeFullV2.Builder newBuilder(com.pycampadb.avro.data.EmployeeFullV2 other) {
    if (other == null) {
      return new com.pycampadb.avro.data.EmployeeFullV2.Builder();
    } else {
      return new com.pycampadb.avro.data.EmployeeFullV2.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EmployeeFullV2>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pycampadb.avro.data.EmployeeFullV2.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pycampadb.avro.data.EmployeeFullV2 other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.firstName)) {
        this.firstName = data().deepCopy(fields()[0].schema(), other.firstName);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.EmployeeFullV2.Builder setFirstName(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.EmployeeFullV2.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.EmployeeFullV2.Builder setLocation(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.EmployeeFullV2.Builder clearLocation() {
      location = null;
