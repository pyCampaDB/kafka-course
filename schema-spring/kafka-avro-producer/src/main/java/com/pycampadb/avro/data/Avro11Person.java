...
public class Avro11Person extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private com.pycampadb.avro.data.Avro11Address address;
  private java.util.List<com.pycampadb.avro.data.Avro11BankAccount> bankAccounts;
   ...
   */
  public Avro11Person(String firstName, String lastName, java.time.LocalDate birthDate, com.pycampadb.avro.data.Avro11Address address, java.util.List<com.pycampadb.avro.data.Avro11BankAccount> bankAccounts) {
  ...
  public void put(int field$, Object value$) {
    ...
    case 3: address = (com.pycampadb.avro.data.Avro11Address)value$; break;
    case 4: bankAccounts = (java.util.List<com.pycampadb.avro.data.Avro11BankAccount>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public com.pycampadb.avro.data.Avro11Address getAddress() {
    return address;
  }
   ...
   * @param value the value to set.
   */
  public void setAddress(com.pycampadb.avro.data.Avro11Address value) {
    this.address = value;
  }
   ...
   */
  public java.util.List<com.pycampadb.avro.data.Avro11BankAccount> getBankAccounts() {
    return bankAccounts;
  }
   ...
   * @param value the value to set.
   */
  public void setBankAccounts(java.util.List<com.pycampadb.avro.data.Avro11BankAccount> value) {
   ...
   */
  public static com.pycampadb.avro.data.Avro11Person.Builder newBuilder() {
    return new com.pycampadb.avro.data.Avro11Person.Builder();
  }
   ...
   * @return A new Avro11Person RecordBuilder
   */
  public static com.pycampadb.avro.data.Avro11Person.Builder newBuilder(com.pycampadb.avro.data.Avro11Person.Builder other) {
    if (other == null) {
      return new com.pycampadb.avro.data.Avro11Person.Builder();
    } else {
      return new com.pycampadb.avro.data.Avro11Person.Builder(other);
    }
  }
   ...
   * @return A new Avro11Person RecordBuilder
   */
  public static com.pycampadb.avro.data.Avro11Person.Builder newBuilder(com.pycampadb.avro.data.Avro11Person other) {
    if (other == null) {
      return new com.pycampadb.avro.data.Avro11Person.Builder();
    } else {
      return new com.pycampadb.avro.data.Avro11Person.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Avro11Person>
    ...
    private java.time.LocalDate birthDate;
    private com.pycampadb.avro.data.Avro11Address address;
    private com.pycampadb.avro.data.Avro11Address.Builder addressBuilder;
    private java.util.List<com.pycampadb.avro.data.Avro11BankAccount> bankAccounts;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pycampadb.avro.data.Avro11Person.Builder other) {
      super(other);
      ...
      if (other.hasAddressBuilder()) {
        this.addressBuilder = com.pycampadb.avro.data.Avro11Address.newBuilder(other.getAddressBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pycampadb.avro.data.Avro11Person other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.firstName)) {
        this.firstName = data().deepCopy(fields()[0].schema(), other.firstName);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro11Person.Builder setFirstName(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro11Person.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro11Person.Builder setLastName(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro11Person.Builder clearLastName() {
      lastName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro11Person.Builder setBirthDate(java.time.LocalDate value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro11Person.Builder clearBirthDate() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro11Person.Builder setAddress(com.pycampadb.avro.data.Avro11Address value) {
     ...
     * @return This builder.
     */
    public com.pycampadb.avro.data.Avro11Address.Builder getAddressBuilder() {
      if (addressBuilder == null) {
        if (hasAddress()) {
          setAddressBuilder(com.pycampadb.avro.data.Avro11Address.newBuilder(address));
        } else {
          setAddressBuilder(com.pycampadb.avro.data.Avro11Address.newBuilder());
        }
      }
    ...
    public com.pycampadb.avro.data.Avro11Person.Builder setAddressBuilder(com.pycampadb.avro.data.Avro11Address.Builder value) {
      clearAddress();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro11Person.Builder clearAddress() {
      address = null;
      addressBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro11Person.Builder setBankAccounts(java.util.List<com.pycampadb.avro.data.Avro11BankAccount> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro11Person.Builder clearBankAccounts() {
      bankAccounts = null;
    ...
    public Avro11Person build() {
      try {
        ...
        if (addressBuilder != null) {
          ...
          record.address = fieldSetFlags()[3] ? this.address : (com.pycampadb.avro.data.Avro11Address) defaultValue(fields()[3]);
        }
        record.bankAccounts = fieldSetFlags()[4] ? this.bankAccounts : (java.util.List<com.pycampadb.avro.data.Avro11BankAccount>) defaultValue(fields()[4]);
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
      } catch (Exception e) {
