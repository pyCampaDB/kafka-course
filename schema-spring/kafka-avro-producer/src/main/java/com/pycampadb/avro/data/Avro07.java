...
public class Avro07 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** mandatory map */
  private java.util.Map<String, String> bestHeroVotes;
  /** map of (array of int) */
  private java.util.Map<String,java.util.List<Integer>> lotteryNumbers;
  /** optional map */
  private java.util.Map<String, String> favouriteFoods;
  /** map with default value */
  private java.util.Map<String, String> favouritePets;
   ...
   */
  public Avro07(java.util.Map<String, String> bestHeroVotes, java.util.Map<String,java.util.List<Integer>> lotteryNumbers, java.util.Map<String, String> favouriteFoods, java.util.Map<String, String> favouritePets) {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: bestHeroVotes = (java.util.Map<String, String>)value$; break;
    case 1: lotteryNumbers = (java.util.Map<String,java.util.List<Integer>>)value$; break;
    case 2: favouriteFoods = (java.util.Map<String, String>)value$; break;
    case 3: favouritePets = (java.util.Map<String, String>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public java.util.Map<String, String> getBestHeroVotes() {
   ...
   */
  public void setBestHeroVotes(java.util.Map<String, String> value) {
   ...
   */
  public java.util.Map<String,java.util.List<Integer>> getLotteryNumbers() {
   ...
   * @param value the value to set.
   */
  public void setLotteryNumbers(java.util.Map<String,java.util.List<Integer>> value) {
   ...
   * @return optional map
   */
  public java.util.Map<String, String> getFavouriteFoods() {
   ...
   * @param value the value to set.
   */
  public void setFavouriteFoods(java.util.Map<String, String> value) {
   ...
   */
  public java.util.Map<String, String> getFavouritePets() {
   ...
   * @param value the value to set.
   */
  public void setFavouritePets(java.util.Map<String, String> value) {
   ...
   */
  public static com.pycampadb.avro.data.Avro07.Builder newBuilder() {
    return new com.pycampadb.avro.data.Avro07.Builder();
  }
   ...
   * @return A new Avro07 RecordBuilder
   */
  public static com.pycampadb.avro.data.Avro07.Builder newBuilder(com.pycampadb.avro.data.Avro07.Builder other) {
    if (other == null) {
      return new com.pycampadb.avro.data.Avro07.Builder();
    } else {
      return new com.pycampadb.avro.data.Avro07.Builder(other);
    }
  }
   ...
   * @return A new Avro07 RecordBuilder
   */
  public static com.pycampadb.avro.data.Avro07.Builder newBuilder(com.pycampadb.avro.data.Avro07 other) {
    if (other == null) {
      return new com.pycampadb.avro.data.Avro07.Builder();
    } else {
      return new com.pycampadb.avro.data.Avro07.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Avro07>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pycampadb.avro.data.Avro07.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pycampadb.avro.data.Avro07 other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.bestHeroVotes)) {
        this.bestHeroVotes = data().deepCopy(fields()[0].schema(), other.bestHeroVotes);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro07.Builder setBestHeroVotes(java.util.Map<String, String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro07.Builder clearBestHeroVotes() {
      bestHeroVotes = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro07.Builder setLotteryNumbers(java.util.Map<String,java.util.List<Integer>> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro07.Builder clearLotteryNumbers() {
      lotteryNumbers = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro07.Builder setFavouriteFoods(java.util.Map<String, String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro07.Builder clearFavouriteFoods() {
      favouriteFoods = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro07.Builder setFavouritePets(java.util.Map<String, String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pycampadb.avro.data.Avro07.Builder clearFavouritePets() {
      favouritePets = null;
    ...
    public Avro07 build() {
      try {
        ...
        record.bestHeroVotes = fieldSetFlags()[0] ? this.bestHeroVotes : (java.util.Map<String, String>) defaultValue(fields()[0]);
        record.lotteryNumbers = fieldSetFlags()[1] ? this.lotteryNumbers : (java.util.Map<String,java.util.List<Integer>>) defaultValue(fields()[1]);
        record.favouriteFoods = fieldSetFlags()[2] ? this.favouriteFoods : (java.util.Map<String, String>) defaultValue(fields()[2]);
        record.favouritePets = fieldSetFlags()[3] ? this.favouritePets : (java.util.Map<String, String>) defaultValue(fields()[3]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    long actualSize0 = 0;
    for (java.util.Map.Entry<String, String> e0: this.bestHeroVotes.entrySet()) {
      actualSize0++;
      out.startItem();
    ...
    long actualSize1 = 0;
    for (java.util.Map.Entry<String, java.util.List<Integer>> e1: this.lotteryNumbers.entrySet()) {
      actualSize1++;
      out.startItem();
      out.writeString(e1.getKey());
      java.util.List<Integer> v1 = e1.getValue();
      long size2 = v1.size();
      out.writeArrayStart();
    ...
    if (this.favouriteFoods == null) {
      ...
      long actualSize3 = 0;
      for (java.util.Map.Entry<String, String> e3: this.favouriteFoods.entrySet()) {
        actualSize3++;
        out.startItem();
    ...
    long actualSize4 = 0;
    for (java.util.Map.Entry<String, String> e4: this.favouritePets.entrySet()) {
      actualSize4++;
      out.startItem();
      out.writeString(e4.getKey());
      String v4 = e4.getValue();
      out.writeString(v4);
    }
    out.writeMapEnd();
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      java.util.Map<String, String> m0 = this.bestHeroVotes; // Need fresh name due to limitation of macro system
      if (m0 == null) {
        m0 = new java.util.HashMap<String, String>((int)size0);
      ...
      java.util.Map<String,java.util.List<Integer>> m1 = this.lotteryNumbers; // Need fresh name due to limitation of macro system
      if (m1 == null) {
        m1 = new java.util.HashMap<String,java.util.List<Integer>>((int)size1);
      ...
      for ( ; 0 < size1; size1 = in.mapNext()) {
        for ( ; size1 != 0; size1--) {
          String k1 = null;
          k1 = in.readString();
          java.util.List<Integer> v1 = null;
          long size2 = in.readArrayStart();
          java.util.List<Integer> a2 = v1;
          if (a2 == null) {
            a2 = new SpecificData.Array<Integer>((int)size2, SCHEMA$.getField("lotteryNumbers").schema().getValueType());
            v1 = a2;
          } else a2.clear();
          SpecificData.Array<Integer> ga2 = (a2 instanceof SpecificData.Array ? (SpecificData.Array<Integer>)a2 : null);
          for ( ; 0 < size2; size2 = in.arrayNext()) {
            for ( ; size2 != 0; size2--) {
              Integer e2 = (ga2 != null ? ga2.peek() : null);
              e2 = in.readInt();
              a2.add(e2);
            }
          }
      ...
      if (in.readIndex() != 1) {
        ...
        java.util.Map<String, String> m3 = this.favouriteFoods; // Need fresh name due to limitation of macro system
        if (m3 == null) {
          m3 = new java.util.HashMap<String, String>((int)size3);
      ...
      java.util.Map<String, String> m4 = this.favouritePets; // Need fresh name due to limitation of macro system
      if (m4 == null) {
        m4 = new java.util.HashMap<String, String>((int)size4);
