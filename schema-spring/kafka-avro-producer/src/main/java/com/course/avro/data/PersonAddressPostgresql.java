...
public class PersonAddressPostgresql extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public PersonAddressPostgresql(String person_id, String id_card_number, String full_name, String email, String address_id, String address, String city, String postal_code) {
   ...
   */
  public static PersonAddressPostgresql.Builder newBuilder() {
    return new PersonAddressPostgresql.Builder();
  }
   ...
   * @return A new PersonAddressPostgresql RecordBuilder
   */
  public static PersonAddressPostgresql.Builder newBuilder(PersonAddressPostgresql.Builder other) {
    if (other == null) {
      return new PersonAddressPostgresql.Builder();
    } else {
      return new PersonAddressPostgresql.Builder(other);
    }
  }
   ...
   * @return A new PersonAddressPostgresql RecordBuilder
   */
  public static PersonAddressPostgresql.Builder newBuilder(PersonAddressPostgresql other) {
    if (other == null) {
      return new PersonAddressPostgresql.Builder();
    } else {
      return new PersonAddressPostgresql.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PersonAddressPostgresql>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(PersonAddressPostgresql.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(PersonAddressPostgresql other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.person_id)) {
        this.person_id = data().deepCopy(fields()[0].schema(), other.person_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public PersonAddressPostgresql.Builder setPersonId(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PersonAddressPostgresql.Builder clearPersonId() {
      person_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public PersonAddressPostgresql.Builder setIdCardNumber(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PersonAddressPostgresql.Builder clearIdCardNumber() {
      id_card_number = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public PersonAddressPostgresql.Builder setFullName(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PersonAddressPostgresql.Builder clearFullName() {
      full_name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public PersonAddressPostgresql.Builder setEmail(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PersonAddressPostgresql.Builder clearEmail() {
      email = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public PersonAddressPostgresql.Builder setAddressId(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PersonAddressPostgresql.Builder clearAddressId() {
      address_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public PersonAddressPostgresql.Builder setAddress(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PersonAddressPostgresql.Builder clearAddress() {
      address = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public PersonAddressPostgresql.Builder setCity(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PersonAddressPostgresql.Builder clearCity() {
      city = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public PersonAddressPostgresql.Builder setPostalCode(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PersonAddressPostgresql.Builder clearPostalCode() {
      postal_code = null;
    ...
    public PersonAddressPostgresql build() {
      try {
        ...
        record.person_id = fieldSetFlags()[0] ? this.person_id : (String) defaultValue(fields()[0]);
        record.id_card_number = fieldSetFlags()[1] ? this.id_card_number : (String) defaultValue(fields()[1]);
        record.full_name = fieldSetFlags()[2] ? this.full_name : (String) defaultValue(fields()[2]);
        record.email = fieldSetFlags()[3] ? this.email : (String) defaultValue(fields()[3]);
        record.address_id = fieldSetFlags()[4] ? this.address_id : (String) defaultValue(fields()[4]);
        record.address = fieldSetFlags()[5] ? this.address : (String) defaultValue(fields()[5]);
        record.city = fieldSetFlags()[6] ? this.city : (String) defaultValue(fields()[6]);
        record.postal_code = fieldSetFlags()[7] ? this.postal_code : (String) defaultValue(fields()[7]);
        return record;
