package com.pycampadb.msvc.command.action.commodity.impl;
...
public class OrderActionImpl implements OrderAction {
    ...
    @Override
    public OrderMessage convertToOrderMessage(Order orderEntity, OrderItem item) {
        var orderMessage = new OrderMessage();

        orderMessage.setOrderNumber(orderEntity.getOrderNumber());
        orderMessage.setCreditCardNumber(orderEntity.getCreditCardNumber());
