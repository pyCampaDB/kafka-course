...
//@Component to FeedbackFourStream
public class FeedbackGoodBadWordsStream implements FeedbackStream {
    ...
    public void kStreamFeedback(StreamsBuilder builder) {
        ...
        builder.stream("t-commodity-feedback", Consumed.with(stringSerde, feedbackSerde))
                ...
                .split()
                .branch(isGoodWord(),
                        Branched.<String, String>withConsumer(
                                ks -> ks.to("t-commodity-feedback-three-good-word")
                        )
                ).branch(isBadWord(),
                        Branched.<String, String>withConsumer(
                                ks -> ks.to("t-commodity-feedback-three-bad-word")
                        )
                );
