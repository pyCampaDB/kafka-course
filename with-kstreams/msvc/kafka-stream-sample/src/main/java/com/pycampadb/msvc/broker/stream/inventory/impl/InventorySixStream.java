...
//@Component
public class InventorySixStream implements InventoryStream {
    private static final String INPUT_TOPIC = "t-commodity-inventory";
    private static final String OUTPUT_TOPIC = "t-commodity-inventory-six";
    private static final Logger log = LoggerFactory.getLogger(InventorySixStream.class);
    ...
    public void kStreamInventory(StreamsBuilder builder) {
        ...
        var timeWindowed = TimeWindows.ofSizeWithNoGrace(windowLength).advanceBy(hopLength);
