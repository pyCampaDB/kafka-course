...
//@Component
public class PremiumOfferOneStream implements PremiumOfferStream {
    ...
    private static final String OFFER_TOPIC = "t-commodity-premium-offer-one";
    ...
    private PremiumOfferMessage joiner (PremiumPurchaseMessage purchase, PremiumUserMessage user){
        return new PremiumOfferMessage(
