...
//@Component
public class SubscriptionOfferTwoStreamImpl implements SubscriptionOfferStream {
    ...
    private static final String OFFER_TOPIC = "t-commodity-subscription-offer-two";
    ...
    public void kStreamSubscriptionOffer(StreamsBuilder builder, ObjectMapper mapper) {
        ...
        var userTable = builder.globalTable(USER_TOPIC, Consumed.with(stringSerde, userSerde));
