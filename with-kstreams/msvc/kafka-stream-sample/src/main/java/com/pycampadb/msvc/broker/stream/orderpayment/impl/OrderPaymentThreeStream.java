...
@Component
public class OrderPaymentThreeStream implements OrderPaymentStream {
    ...
    private static final String OUTPUT_TOPIC = "t-commodity-join-order-payment-three";
