...
import com.pycampadb.msvc.util.orderpayment.OnlineOrderTimestampExtractor;
import com.pycampadb.msvc.util.orderpayment.OnlinePaymentTimestampExtractor;
...
//@Component
public class OrderPaymentOneStream implements OrderPaymentStream {
    ...
    private static final String OUTPUT_TOPIC = "t-commodity-join-order-payment-one";
    ...
    private OnlineOrderPaymentMessage joinOrderPayment (OnlineOrderMessage order, OnlinePaymentMessage payment){
        return new OnlineOrderPaymentMessage(
                order.getOnlineOrderNumber(),
